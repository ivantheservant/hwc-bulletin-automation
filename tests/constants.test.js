...
test('CONFIG_KEYS 剛好 88 個（與 DEFAULTS 一一對應）', function () {
  assert.strictEqual(Object.keys(CONFIG_KEYS).length, 88);
});
...
test('DEFAULTS 剛好 88 筆（之前的 87 ＋ 使用者測試模式的 1）', function () {
  assert.strictEqual(DEFAULTS.length, 88);
});
